            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item"><a href="/pnsystem/day1/landingpage.php" class="nav-link" style="color:black;">Login</a></li>
                        <li class="nav-item "><a href="/pnsystem/day1/landingpage.php" class="nav-link" style="color:black;">Admin</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <div class="container px-2 px-md-4 py-5 mx-auto">
        <div class="card card0 border-0">
            <div class="row d-flex">
                ...
                <div class="col-lg-7">
                    <div class="card2 card border-0 px-4 px-sm-5 py-5">I already have an account? <small
                            class="text-right mb-3"><a href=""><u style="color: blue;">Log in</u></a></small>
                        ...
                        <form action="registerprocess.php"  method="POST">
                            ...
                            <div class="row px-3 mb-3"> <small class="text-muted">By signing up, you agree our <a
                                        ...
                                        class="text-primary">Privacy Policy</a></small> </div>
                            <div class="row mb-4">
                                <div class="col-md-6">
                    ...
                    <div class="col-xl-4 col-md-4 mb-30">
                        <div class="single-cta">
                            ...
                            <div class="cta-text">
                                ...
                                <span>Thomas Missonnier Center, Samjung Building, Nasipit Road, talamban, 6000 Cebu
                    ...
                    <div class="col-xl-4 col-lg-4 mb-50">
                        <div class="footer-widget">
                            ...
                            <div class="footer-text">
                                <strong>
                                    <p>Passerelles Numeriques Philippines</p>
                                </strong>
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="subscribe-form">
                                <form action=""><a href="https://gmail.com/">
                                        <input type="text" placeholder="Email Address" style="background-color:white;">
                                    </a>
                                    <button> <a href="https://gmail.com/"></a><i
                                            class="fab fa-telegram-plane"></i></a></button>
