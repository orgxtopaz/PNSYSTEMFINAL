...
if(isset($_POST['submitlogin'])){ //IF SUBMIT LOGIN IS CLICKED THEN DO THE FOLLOWING CONDITION
   
   

    $email = $_POST['email'];
    $password = $_POST['password']; 
    $hashed_password =sha1($password); //THE INPUTED PASSWORD IS BEING HASHED

    $query = "SELECT * FROM register WHERE email= '$email' && password ='$hashed_password' ";
...
if(isset($_POST['adminlogin'])){
    ...
    $passwordadmin_hashed=sha1($password);


    $query = "SELECT * FROM admin WHERE user= '$user' && password ='$passwordadmin_hashed' ";
    $data =  mysqli_query($conn, $query);
    $total =  mysqli_num_rows($data);
...
if(isset($_SESSION['user'])){
    ...
    header("location:/pnsystem/day1/admindashboard/adminhome.php");
...
<div class="modal-dialog modal-login">
		<div class="modal-content">
			<div class="modal-header">
				<div class="avatar">
					<img src="https://drakemall-files-new.s3.eu-central-1.amazonaws.com/LED%20Purg-ck23q2uch000i01sazbhzb7i5.png" alt="Avatar">
				</div>	
			...
			<div class="modal-body">
				<form action="" method="POST">
					<div class="form-group">
						<input type="text" class="form-control" name="adminuser" placeholder="User" required="required">		
					</div>
					<div class="form-group">
						<input type="password" class="form-control" name="adminpassword" placeholder="Password" required="required">	
					</div>        
					<div class="form-group">
						<button type="submit" class="btn btn-primary addtocart btn-lg btn-block login-btn" name="adminlogin">Login</button>
					</div>
				</form>
			</div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item"><a href="#admin" class="nav-link "  class="trigger-btn"  data-toggle="modal" style="color:black;">Admin</a></li>
